...
Storybook is here:
* Production: <https://github.com/ucsb-cs156-f22/jpa03-ruiqiRichard-docs>
* QA:  <https://ucsb-cs156-f22.github.io/jpa03-ruiqiRichard-docs-qa>

The GitHub actions script to deploy the Storybook to QA requires some configuration; see [docs/github-actions.md](docs/github-actions.md) for details.

If these repos are not yet setup, see the setup steps in [`docs/storybook.md`](docs/storybook.md).

[![codecov](https://codecov.io/gh/ucsb-cs156-f22/jpa03-ruiqiRichard/branch/main/graph/badge.svg?token=WJX0RCRFQE)](https://codecov.io/gh/ucsb-cs156-f22/jpa03-ruiqiRichard)
